...
const PubSubTopic = "fill-room-details"
...
func init() {
	...
	//
    DB, err = configureDatastoreDB("id4gstay")
	// [END datastore]
	...
	// production.
	//
	OAuthConfig = configureOAuthClient("10244266821-r6cg6pvl20susk8an39okic7r18gn1ke.apps.googleusercontent.com", 
	  "W90dOzLymkdY7t5d1wbPwFI4")
	// [END auth]
	...
	cookieStore := sessions.NewCookieStore([]byte("Soygenio2098"))
...
func configureOAuthClient(clientID, clientSecret string) *oauth2.Config {
	...
	if redirectURL == "" {
		...
		redirectURL = "https://w4gstay-tconejeros.c9users.io/oauth2callback"
	}
